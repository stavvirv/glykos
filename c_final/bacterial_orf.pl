print "Παρακαλώ εισάγετε μία νουκλεοτιδική αλληλουχία, χωρίς να δίνετε απαραίτητα τον προσανατολισμό της και εγώ θα ψάξω για την ύπαρξη διαφόρων orfs εξετάζοντάς την και προς τις κατευθύνσεις. Σε περίπτωση που γνωρίζετε τον προσανατολισμό της δοθείσας αλληλουχίας απλώς αγνοήστε τα orfs που βρήκα έχοντας θεωρήσει ότι η αλυσίδα θα μπορούσε να έχει και τον άλλον προσανατολισμό.\n";
